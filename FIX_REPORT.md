...
False Positive: 0
Blocked: 0
Deferred: 3 (NET-007, NET-008, NET-002 partial)
...
| NET-007 | SSRF DNS rebinding | DEFERRED | Requires custom HTTP agent |
| NET-008 | gRPC bind to 127.0.0.1 | DEFERRED | Requires Python service changes |
